...
__data __at(0x38) char az;
__data __at (0x39) char onine;
__data __at (0x6D) char turn; //2 for prod2, 1 for prod1, 0 for consumer
__data __at (0x6E) char prev_turn; // 2 for prod2, 1 for prod 1
...
void Producer2(void) {
        ...
        while (1) {
                ...
                */
                ...
                SemaphoreWait(mutex);
                        __critical{
                                shared_buff[head] = onine;
                                head = (head + 1) %3;
                                onine = (onine + 1 - '0') % 10 + '0';
                        }
                        // EA = 1;
                // }
                // ThreadYield();
